...
using JDKTrap.Models;
using JDKTrap.UI.Elements.ContextMenu;
...
namespace JDKTrap
{
    public class Watcher : IDisposable
    {
        ...
        public async Task Run()
        {
            ...
            Process? robloxProc = null;
            try
            {
                robloxProc = Process.GetProcessById(_watcherData.ProcessId);
            }
            catch (ArgumentException)
            {
                // Process is not running or has already exited
            }
