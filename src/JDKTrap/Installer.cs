...
namespace JDKTrap
{
    internal class Installer
    {
        ...
        public bool JDKTrapRPCReal = true;
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs JDKTrap, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "1.0.3.6") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "JDKTrap");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\JDKTrap", false);
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-JDKTrap-v{currentVer}");
