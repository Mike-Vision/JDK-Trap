    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconJDKTrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconJDKTrap => Properties.Resources.IconJDKTrap,
                ...
                _ => Properties.Resources.IconJDKTrap
            };
        }
    }
}
