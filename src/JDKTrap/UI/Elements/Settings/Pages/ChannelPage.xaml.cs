    ...
    public partial class ChannelPage
    {
        ...
        private void ApplyNow_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Frontend.ShowMessageBox("JDKTrap Settings/Mods Synced"); // diddy is synced :)))))))))) eheh not funny ik.. sorry
            }
            catch (Exception ex)
            {
        ...
        private async void Check_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    Frontend.ShowMessageBox(
                        "You are already running the latest version of JDKTrap."
                    );
                }
            }
            catch (Exception ex)
