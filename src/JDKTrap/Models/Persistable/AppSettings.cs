...
namespace JDKTrap.Models.Persistable
{
    /// <summary>
    /// Represents configuration settings for JDKTrap.
    /// </summary>
    public class AppSettings
    {
        // General Configuration
        public BootstrapperStyle BootstrapperStyle { get; set; } = BootstrapperStyle.FluentAeroDialog;
        public BootstrapperIcon BootstrapperIcon { get; set; } = BootstrapperIcon.IconJDKTrap;
